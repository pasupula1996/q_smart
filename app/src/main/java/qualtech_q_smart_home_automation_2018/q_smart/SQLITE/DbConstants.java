...
public class DbConstants {
    ...
    static final String DB_NAME = "CUSTOMIZED_MENU_DB";
    ...
    //SECURITY DATABASE VARIABLES
    protected static final String SECURITY_TB_NAME = "SECURITY_DB";
    public static final String SECURITY_ID = "C_ID";
    public static final String SECURITY_TITLE = "C_TITLE";
    public static final String SECURITY_THUMBNAIL = "C_THUMBNAIL";
    public static final String SECURITY_CLICKED = "C_CLICKED";

    static final String CREATE_SECURITY_TB = "CREATE TABLE SECURITY_DB (C_ID INTEGER PRIMARY KEY AUTOINCREMENT,"
            + "C_TITLE TEXT NOT NULL," + "C_THUMBNAIL INTEGER," + "C_CLICKED TEXT NOT NULL);";
    static final String DROP_SECURITY_TABLE = "DROP TABLE IF EXISTS" + SECURITY_TB_NAME;
}
