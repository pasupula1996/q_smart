...
public class KitchenFragment extends Fragment {
    ...
    LinearLayout kitchenLightLayout,kitchenDimmerLayout,kitchenfanLayout,kitchenPlugLayout;
    ImageView kitchenRoomPic,kitchenPic;
    TextView renameKitchenRoom;
    ...
    Dialog kDialogL, kDialogF,kDialogP, kDialogD;
   ...
   // SharedPreferences mPref;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPref = getActivity().getSharedPreferences("Kitchen_values",0);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        kitchenLightLayout = view.findViewById(R.id.kitchen_lights);
        kitchenDimmerLayout = view.findViewById(R.id.kitchen_dimmer_dialog_layout);
        kitchenfanLayout = view.findViewById(R.id.kitchen_fan_dialog_layout);
        kitchenPlugLayout = view.findViewById(R.id.kitchen_plug_layout);

        kitchenRoomPic = view.findViewById(R.id.edit_kitchen_cover_photo);
        renameKitchenRoom = view.findViewById(R.id.rename_kitchen_room);
        kitchenPic = view.findViewById(R.id.kitchen_room);
        kitchenRoomPic.setImageResource(R.drawable.ic_edit_black);


        kitchenLightLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                kDialogL = new Dialog(getContext());
                kDialogL.setContentView(R.layout.light_dialog);
                TextView title = kDialogL.findViewById(R.id.light_dialog_title);
                title.setText("Kitchen Room");

                allLightsImg = kDialogL.findViewById(R.id.light_dialog_imageView_all);
                allLightsTxt = kDialogL.findViewById(R.id.light_dialog_all_lights_txt_click);

                lightOneImg = kDialogL.findViewById(R.id.light_dialog_imageView_one);
                lightOneTxt = kDialogL.findViewById(R.id.light_dialog_light_one_txt_click);
                lightTwoImg = kDialogL.findViewById(R.id.light_dialog_imageView_two);
                lightTwoTxt = kDialogL.findViewById(R.id.light_dialog_light_two_txt_click);
                lightThreeImg = kDialogL.findViewById(R.id.light_dialog_imageView_three);
                lightThreeTxt = kDialogL.findViewById(R.id.light_dialog_light_three_txt_click);
                lightFourImg = kDialogL.findViewById(R.id.light_dialog_imageView_four);
                lightFourTxt = kDialogL.findViewById(R.id.light_dialog_light_four_txt_click);
                lightFiveImg = kDialogL.findViewById(R.id.light_dialog_imageView_five);
                lightFiveTxt = kDialogL.findViewById(R.id.light_dialog_light_five_txt_click);
                lightSixImg = kDialogL.findViewById(R.id.light_dialog_imageView_six);
                lightSixTxt = kDialogL.findViewById(R.id.light_dialog_light_six_txt_click);
                lightSevenImg = kDialogL.findViewById(R.id.light_dialog_imageView_seven);
                lightSevenTxt = kDialogL.findViewById(R.id.light_dialog_light_seven_txt_click);
                lightEightImg = kDialogL.findViewById(R.id.light_dialog_imageView_eight);
                lightEightTxt = kDialogL.findViewById(R.id.light_dialog_light_eight_txt_click);
        ...
        kitchenfanLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                kDialogF = new Dialog(getContext());
                kDialogF.setContentView(R.layout.fan_dialog_layout);
                TextView title = kDialogF.findViewById(R.id.fan_dialog_title);
                title.setText("Kitchen Room");

                allFansImg = kDialogF.findViewById(R.id.fan_dialog_img_one);
                allFansTxt = kDialogF.findViewById(R.id.fan_one_btn);

                fanOneImg = kDialogF.findViewById(R.id.fan_dialog_img_two);
                fanOneTxt = kDialogF.findViewById(R.id.fan_two_btn);
                fanTwoImg = kDialogF.findViewById(R.id.fan_dialog_img_three);
                fanTwoTxt = kDialogF.findViewById(R.id.Fan_three_btn);
                fanOneSeek = kDialogF.findViewById(R.id.fan_one_seek_bar);
                fanTwoSeek = kDialogF.findViewById(R.id.fan_two_seek_bar);
                kDialogF.show();
        ...
        kitchenDimmerLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                kDialogD = new Dialog(getContext());
                kDialogD.setContentView(R.layout.dimmer_dialog_layout);
                TextView title = kDialogD.findViewById(R.id.dimmer_dialog_title);
                title.setText("Kitchen Room");

                allDimmerImg = kDialogD.findViewById(R.id.dimmer_dialog_img_one);
                allDimmerTxt = kDialogD.findViewById(R.id.dimmer_one_btn);
                dimmerOneImg = kDialogD.findViewById(R.id.dimmer_dialog_img_two);
                dimmerOneTxt = kDialogD.findViewById(R.id.dimmer_two_btn);
                dimmerOneSeek = kDialogD.findViewById(R.id.dimmer_one_seek_bar);

                dimmerTwoImg = kDialogD.findViewById(R.id.dimmer_dialog_img_three);
                dimmerTwoTxt = kDialogD.findViewById(R.id.dimmer_three_btn);
                dimmerTwoSeek = kDialogD.findViewById(R.id.dimmer_two_seek_bar);
        ...
        kitchenPlugLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                kDialogP = new Dialog(getContext());
                kDialogP.setContentView(R.layout.plug_dialog_layout);
                TextView title = kDialogP.findViewById(R.id.plug_dialog_title);
                title.setText("Kitchen Room");

                allPlugsImg = kDialogP.findViewById(R.id.plug_image_view_all);
                allPlugsTxt = kDialogP.findViewById(R.id.plug_btn_all);

                plugOneImg = kDialogP.findViewById(R.id.plug_image_view_one);
                plugOneTxt = kDialogP.findViewById(R.id.plug_btn_one);
                plugTwoImg = kDialogP.findViewById(R.id.plug_image_view_two);
                plugTwoTxt = kDialogP.findViewById(R.id.plug_btn_two);
                plugThreeImg = kDialogP.findViewById(R.id.plug_image_view_three);
                plugThreeTxt = kDialogP.findViewById(R.id.plug_btn_three);
                plugFourImg = kDialogP.findViewById(R.id.plug_image_view_four);
                plugFourTxt = kDialogP.findViewById(R.id.plug_btn_four);
        ...
        kitchenRoomPic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        renameKitchenRoom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                updateName.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        renameKitchenRoom.setText(edtValue.getText().toString());
                        mPref.edit().putString("kitchenRoom_Name",edtValue.getText().toString()).apply();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try{
            if (requestCode == 1 && null != data && data.getData() != null){
                ...
                kitchenPic.setImageBitmap(bmp);
                editor = mPref.edit();
                editor.putString("kitchenRoom_Picture1",picturePath).apply();
                editor.putString("kitchenRoom_Picture2",null).apply();
                ...
                editor = mPref.edit();
                editor.putString("kitchenRoom_Picture2",bitmapString).apply();
                editor.putString("kitchenRoom_Picture1",null).apply();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        String s = mPref.getString("kitchenRoom_Picture1",null);
        String bytes = mPref.getString("kitchenRoom_Picture2",null);

        if (s != null){
            Bitmap bitmap = BitmapFactory.decodeFile(s);
           kitchenPic.setImageBitmap(bitmap);
        }else if (bytes != null) {
            Bitmap bmp = Constants.StringToBitmap(bytes);
            kitchenPic.setImageBitmap(bmp);
        }
        else {
            kitchenPic.setImageResource(R.drawable.kitchen_back);
        }
        String re = mPref.getString("kitchenRoom_Name","Default Kitchen name");
        renameKitchenRoom.setText(re);
    }
}
