...
public class HomeFragment extends Fragment {
    ...
    ImageView homeLightLayout,homeDimmerLayout,homefanLayout,homePlugLayout;
    ImageView homeRoomPic,homePic, homeTvControl;
    TextView renameHomeRoom;
    ...
    Dialog hDialogL, hDialogF,hDialogP, hDialogD;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ii = new Intent(getContext(),BluetoothServices.class);
        getActivity().bindService(ii,mConnection, Context.BIND_AUTO_CREATE);
        mPref = getActivity().getSharedPreferences("home_values",0);
        ((SimpleMenuActivity)getActivity()).mTabLayout.setVisibility(View.GONE);
        //((AppCompatActivity)getContext()).getActionBar().hide();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        homeLightLayout = view.findViewById(R.id.home_lights_layout);
        homeDimmerLayout = view.findViewById(R.id.home_dimmer_dialog_layout);
        homefanLayout = view.findViewById(R.id.home_fan_dialog_layout);
        homePlugLayout = view.findViewById(R.id.home_plug_layout);

        homeRoomPic = view.findViewById(R.id.edit_home_cover_btn);
        renameHomeRoom = view.findViewById(R.id.rename_home_room);
        homePic = view.findViewById(R.id.home_room);
        homeRoomPic.setImageResource(R.drawable.ic_edit_black);
        homeTvControl = view.findViewById(R.id.home_tv_controls);

        homeTvControl.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        homeLightLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                hDialogL = new Dialog(getContext());
                hDialogL.setContentView(R.layout.light_dialog);
                TextView title = hDialogL.findViewById(R.id.light_dialog_title);
                title.setText("Home");
                allLightsImg = hDialogL.findViewById(R.id.light_dialog_imageView_all);
                allLightsTxt = hDialogL.findViewById(R.id.light_dialog_all_lights_txt_click);

                lightOneImg = hDialogL.findViewById(R.id.light_dialog_imageView_one);
                lightOneTxt = hDialogL.findViewById(R.id.light_dialog_light_one_txt_click);
                lightTwoImg = hDialogL.findViewById(R.id.light_dialog_imageView_two);
                lightTwoTxt = hDialogL.findViewById(R.id.light_dialog_light_two_txt_click);
                lightThreeImg = hDialogL.findViewById(R.id.light_dialog_imageView_three);
                lightThreeTxt = hDialogL.findViewById(R.id.light_dialog_light_three_txt_click);
                lightFourImg = hDialogL.findViewById(R.id.light_dialog_imageView_four);
                lightFourTxt = hDialogL.findViewById(R.id.light_dialog_light_four_txt_click);
                lightFiveImg = hDialogL.findViewById(R.id.light_dialog_imageView_five);
                lightFiveTxt = hDialogL.findViewById(R.id.light_dialog_light_five_txt_click);
                lightSixImg = hDialogL.findViewById(R.id.light_dialog_imageView_six);
                lightSixTxt = hDialogL.findViewById(R.id.light_dialog_light_six_txt_click);
                lightSevenImg = hDialogL.findViewById(R.id.light_dialog_imageView_seven);
                lightSevenTxt = hDialogL.findViewById(R.id.light_dialog_light_seven_txt_click);
                lightEightImg = hDialogL.findViewById(R.id.light_dialog_imageView_eight);
                lightEightTxt = hDialogL.findViewById(R.id.light_dialog_light_eight_txt_click);
        ...
        homefanLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                hDialogF = new Dialog(getContext());
                hDialogF.setContentView(R.layout.fan_dialog_layout);
                TextView title = hDialogF.findViewById(R.id.fan_dialog_title);
                title.setText("Home");

                allFansImg = hDialogF.findViewById(R.id.fan_dialog_img_one);
                allFansTxt = hDialogF.findViewById(R.id.fan_one_btn);

                fanOneImg = hDialogF.findViewById(R.id.fan_dialog_img_two);
                fanOneTxt = hDialogF.findViewById(R.id.fan_two_btn);
                fanTwoImg = hDialogF.findViewById(R.id.fan_dialog_img_three);
                fanTwoTxt = hDialogF.findViewById(R.id.Fan_three_btn);
                fanOneSeek = hDialogF.findViewById(R.id.fan_one_seek_bar);
                fanTwoSeek = hDialogF.findViewById(R.id.fan_two_seek_bar);
                hDialogF.show();
        ...
        homeDimmerLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                hDialogD = new Dialog(getContext());
                hDialogD.setContentView(R.layout.dimmer_dialog_layout);
                TextView title = hDialogD.findViewById(R.id.dimmer_dialog_title);
                title.setText("Home");

                allDimmerImg = hDialogD.findViewById(R.id.dimmer_dialog_img_one);
                allDimmerTxt = hDialogD.findViewById(R.id.dimmer_one_btn);
                dimmerOneImg = hDialogD.findViewById(R.id.dimmer_dialog_img_two);
                dimmerOneTxt = hDialogD.findViewById(R.id.dimmer_two_btn);
                dimmerOneSeek = hDialogD.findViewById(R.id.dimmer_one_seek_bar);

                dimmerTwoImg = hDialogD.findViewById(R.id.dimmer_dialog_img_three);
                dimmerTwoTxt = hDialogD.findViewById(R.id.dimmer_three_btn);
                dimmerTwoSeek = hDialogD.findViewById(R.id.dimmer_two_seek_bar);
        ...
        homePlugLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                hDialogP = new Dialog(getContext());
                hDialogP.setContentView(R.layout.plug_dialog_layout);
                TextView title = hDialogP.findViewById(R.id.plug_dialog_title);
                title.setText("Home");

                allPlugsImg = hDialogP.findViewById(R.id.plug_image_view_all);
                allPlugsTxt = hDialogP.findViewById(R.id.plug_btn_all);

                plugOneImg = hDialogP.findViewById(R.id.plug_image_view_one);
                plugOneTxt = hDialogP.findViewById(R.id.plug_btn_one);
                plugTwoImg = hDialogP.findViewById(R.id.plug_image_view_two);
                plugTwoTxt = hDialogP.findViewById(R.id.plug_btn_two);
                plugThreeImg = hDialogP.findViewById(R.id.plug_image_view_three);
                plugThreeTxt = hDialogP.findViewById(R.id.plug_btn_three);
                plugFourImg = hDialogP.findViewById(R.id.plug_image_view_four);
                plugFourTxt = hDialogP.findViewById(R.id.plug_btn_four);
        ...
        homeRoomPic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        renameHomeRoom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                updateName.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        renameHomeRoom.setText(edtValue.getText().toString());
                        mPref.edit().putString("homeRoom_Name",edtValue.getText().toString()).apply();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try{
            if (requestCode == 1 && null != data && data.getData() != null){
                ...
                homePic.setImageBitmap(bmp);
                editor = mPref.edit();
                editor.putString("homeRoom_Picture1",picturePath).apply();
                ...
                editor = mPref.edit();
                editor.putString("homeRoom_Picture2",bitmapString).apply();
                editor.putString("homeRoom_Picture1",null).apply();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        String s = mPref.getString("homeRoom_Picture1",null);
        String bytes = mPref.getString("homeRoom_Picture2",null);
        ...
        if (s != null){
            ...
            homePic.setImageResource(R.drawable.home_background);
        }
        String re = mPref.getString("homeRoom_Name","Home");
        renameHomeRoom.setText(re);
    }
