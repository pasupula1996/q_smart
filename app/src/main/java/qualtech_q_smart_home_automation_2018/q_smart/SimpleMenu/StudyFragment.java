...
public class StudyFragment extends Fragment {
    ...
    LinearLayout studyLightLayout,studyDimmerLayout,studyfanLayout,studyPlugLayout;
    ImageView studyRoomPic,studyPic, studyTvControl;
    TextView renameStudyRoom;
    ...
    Dialog sDialogL, sDialogF,sDialogP, sDialogD;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPref = getActivity().getSharedPreferences("study_fragment_values",0);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        studyLightLayout = view.findViewById(R.id.study_lights);
        studyDimmerLayout = view.findViewById(R.id.study_dimmer_dialog_layout);
        studyfanLayout = view.findViewById(R.id.study_fan_dialog_layout);
        studyPlugLayout = view.findViewById(R.id.study_plug_layout);

        studyRoomPic = view.findViewById(R.id.edit_study_cover_btn);
        renameStudyRoom = view.findViewById(R.id.rename_study_room);
        studyPic = view.findViewById(R.id.study_room);
        studyTvControl = view.findViewById(R.id.study_tv_controls);
        studyRoomPic.setImageResource(R.drawable.ic_edit_black);

        studyLightLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sDialogL = new Dialog(getContext());
                sDialogL.setContentView(R.layout.light_dialog);
                TextView title = sDialogL.findViewById(R.id.light_dialog_title);
                title.setText("study Room");

                allLightsImg = sDialogL.findViewById(R.id.light_dialog_imageView_all);
                allLightsTxt = sDialogL.findViewById(R.id.light_dialog_all_lights_txt_click);

                lightOneImg = sDialogL.findViewById(R.id.light_dialog_imageView_one);
                lightOneTxt = sDialogL.findViewById(R.id.light_dialog_light_one_txt_click);
                lightTwoImg = sDialogL.findViewById(R.id.light_dialog_imageView_two);
                lightTwoTxt = sDialogL.findViewById(R.id.light_dialog_light_two_txt_click);
                lightThreeImg = sDialogL.findViewById(R.id.light_dialog_imageView_three);
                lightThreeTxt = sDialogL.findViewById(R.id.light_dialog_light_three_txt_click);
                lightFourImg = sDialogL.findViewById(R.id.light_dialog_imageView_four);
                lightFourTxt = sDialogL.findViewById(R.id.light_dialog_light_four_txt_click);
                lightFiveImg = sDialogL.findViewById(R.id.light_dialog_imageView_five);
                lightFiveTxt = sDialogL.findViewById(R.id.light_dialog_light_five_txt_click);
                lightSixImg = sDialogL.findViewById(R.id.light_dialog_imageView_six);
                lightSixTxt = sDialogL.findViewById(R.id.light_dialog_light_six_txt_click);
                lightSevenImg = sDialogL.findViewById(R.id.light_dialog_imageView_seven);
                lightSevenTxt = sDialogL.findViewById(R.id.light_dialog_light_seven_txt_click);
                lightEightImg = sDialogL.findViewById(R.id.light_dialog_imageView_eight);
                lightEightTxt = sDialogL.findViewById(R.id.light_dialog_light_eight_txt_click);
        ...
        studyfanLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sDialogF = new Dialog(getContext());
                sDialogF.setContentView(R.layout.fan_dialog_layout);
                TextView title = sDialogF.findViewById(R.id.fan_dialog_title);
                title.setText("Study Room");

                allFansImg = sDialogF.findViewById(R.id.fan_dialog_img_one);
                allFansTxt = sDialogF.findViewById(R.id.fan_one_btn);

                fanOneImg = sDialogF.findViewById(R.id.fan_dialog_img_two);
                fanOneTxt = sDialogF.findViewById(R.id.fan_two_btn);
                fanTwoImg = sDialogF.findViewById(R.id.fan_dialog_img_three);
                fanTwoTxt = sDialogF.findViewById(R.id.Fan_three_btn);
                fanOneSeek = sDialogF.findViewById(R.id.fan_one_seek_bar);
                fanTwoSeek = sDialogF.findViewById(R.id.fan_two_seek_bar);
                sDialogF.show();
        ...
        studyDimmerLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sDialogD = new Dialog(getContext());
                sDialogD.setContentView(R.layout.dimmer_dialog_layout);
                TextView title = sDialogD.findViewById(R.id.dimmer_dialog_title);
                title.setText("Study Room");

                allDimmerImg = sDialogD.findViewById(R.id.dimmer_dialog_img_one);
                allDimmerTxt = sDialogD.findViewById(R.id.dimmer_one_btn);
                dimmerOneImg = sDialogD.findViewById(R.id.dimmer_dialog_img_two);
                dimmerOneTxt = sDialogD.findViewById(R.id.dimmer_two_btn);
                dimmerOneSeek = sDialogD.findViewById(R.id.dimmer_one_seek_bar);

                dimmerTwoImg = sDialogD.findViewById(R.id.dimmer_dialog_img_three);
                dimmerTwoTxt = sDialogD.findViewById(R.id.dimmer_three_btn);
                dimmerTwoSeek = sDialogD.findViewById(R.id.dimmer_two_seek_bar);
        ...
        studyPlugLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sDialogP = new Dialog(getContext());
                sDialogP.setContentView(R.layout.plug_dialog_layout);
                TextView title = sDialogP.findViewById(R.id.plug_dialog_title);
                title.setText("Study Room");

                allPlugsImg = sDialogP.findViewById(R.id.plug_image_view_all);
                allPlugsTxt = sDialogP.findViewById(R.id.plug_btn_all);

                plugOneImg = sDialogP.findViewById(R.id.plug_image_view_one);
                plugOneTxt = sDialogP.findViewById(R.id.plug_btn_one);
                plugTwoImg = sDialogP.findViewById(R.id.plug_image_view_two);
                plugTwoTxt = sDialogP.findViewById(R.id.plug_btn_two);
                plugThreeImg = sDialogP.findViewById(R.id.plug_image_view_three);
                plugThreeTxt = sDialogP.findViewById(R.id.plug_btn_three);
                plugFourImg = sDialogP.findViewById(R.id.plug_image_view_four);
                plugFourTxt = sDialogP.findViewById(R.id.plug_btn_four);
        ...
        studyTvControl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        studyRoomPic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        renameStudyRoom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                updateName.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        renameStudyRoom.setText(edtValue.getText().toString());
                        mPref.edit().putString("studyRoom_Name",edtValue.getText().toString()).apply();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try{
            if (requestCode == 1 && null != data && data.getData() != null){
                ...
                studyPic.setImageBitmap(bmp);
                editor = mPref.edit();
                editor.putString("studyRoom_Picture1",picturePath).apply();
                editor.putString("studyRoom_Picture2",null).apply();
                ...
                editor = mPref.edit();
                editor.putString("studyRoom_Picture2",bitmapString).apply();
                editor.putString("studyRoom_Picture1",null).apply();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        String s = mPref.getString("studyRoom_Picture1",null);
        String bytes = mPref.getString("studyRoom_Picture2",null);


        if (s != null){
            Bitmap bitmap = BitmapFactory.decodeFile(s);
            studyPic.setImageBitmap(bitmap);
        }else if (bytes != null) {
            Bitmap bmp = Constants.StringToBitmap(bytes);
            studyPic.setImageBitmap(bmp);
        }else {
            studyPic.setImageResource(R.drawable.study_room_back);
        }
        String re = mPref.getString("studyRoom_Name","Study room");
        renameStudyRoom.setText(re);
    }
