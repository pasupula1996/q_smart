...
import qualtech_q_smart_home_automation_2018.q_smart.RecyclerViews.LightRecyclerView;
import qualtech_q_smart_home_automation_2018.q_smart.SQLITE.LDbHelper;
import qualtech_q_smart_home_automation_2018.q_smart.SQLITE.LightDbConstants;
...
import static qualtech_q_smart_home_automation_2018.q_smart.SQLITE.LightDbConstants.ROW_TITLE;
...
public class LightFragment extends Fragment {
    ...
    private boolean add(String name, int thumbnail, boolean click){
        ...
        values.put(LightDbConstants.ROW_TITLE,name);
        values.put(LightDbConstants.ROW_THUMBNAIL,thumbnail);
        values.put(LightDbConstants.ROW_CLICKED,String.valueOf(click));
        db.insert(LightDbConstants.TB_NAME,LightDbConstants.ROW_ID,values);
        closeDb();
