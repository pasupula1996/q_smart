...
public class CustomMenuActivity extends AppCompatActivity {
    ...
    public static CustomMenuActivity instance;
    ...
    public void simpleMenuClickListener(){
        mLightTxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                lightFm = new LightFragment(CustomMenuActivity.this);
        ...
        mUtilities.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                UtilitiesFragment uFragment = new UtilitiesFragment(CustomMenuActivity.this);
                FragmentTransaction fragmentTransaction = fm.beginTransaction();
                fm.popBackStack();
                fragmentTransaction.addToBackStack(null);
        ...
        mEntertainment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EntertainmentFragment eFragment = new EntertainmentFragment(CustomMenuActivity.this);
                FragmentTransaction fragmentTransaction = fm.beginTransaction();
                fm.popBackStack();
                fragmentTransaction.addToBackStack(null);
        ...
        mServices.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ServiceFragment sFragment = new ServiceFragment(CustomMenuActivity.this);
                fm.popBackStack();
                FragmentTransaction fragmentTransaction = fm.beginTransaction();
                fragmentTransaction.addToBackStack(null);
        ...
        mSecurity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SecurityFragment securityFragment = new SecurityFragment(CustomMenuActivity.this);
                FragmentTransaction fragmentTransaction = fm.beginTransaction();
                fm.popBackStack();
                fragmentTransaction.addToBackStack(null);
